...
namespace MakerPrompt.UI.Components.Utils
{
    public static class ServiceCollectionExtensions
    {
            ...
            where L : class, ISerialService
        {
			...
			services.AddScoped<PrinterConnectionDefinitionProtector>();
			services.AddScoped<PrinterConfigurationPersistence>();
			services.AddScoped<IPrinterBackendFactory, PrinterBackendFactory<L>>();
			services.AddScoped<PrinterConnectionManager>();
			services.AddScoped<FarmConfigurationService>();
