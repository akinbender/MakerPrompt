...
public sealed class MjpegCameraProvider(
    string cameraId,
    string label,
    string streamUrl,
    ILogger<MjpegCameraProvider> logger) : ICameraProvider
{
    ...
    private readonly string _streamUrl = streamUrl;
    private readonly ILogger<MjpegCameraProvider> _logger = logger;
