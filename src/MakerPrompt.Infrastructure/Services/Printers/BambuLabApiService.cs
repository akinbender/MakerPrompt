...
public sealed class BambuLabApiService : BasePrinterConnectionService, IPrinterCommunicationService
{
    ...
    public bool SupportsCommandPrompt => false;
    ...
    private async Task SendCommandAsync(
        string name, object payload, CancellationToken cancellationToken = default)
    {
    ...
    public Task StartPrintAsync(GCodeDoc gcodeDoc, CancellationToken cancellationToken = default)
    {
        ...
        return Task.Run(async () =>
        {
            await foreach (var command in gcodeDoc.EnumerateCommandsAsync(_cts.Token))
            {
                ...
                await SendCommandAsync("gcode_line", new { command }, cancellationToken);
            }
        });
    }

    public Task SaveEepromAsync(CancellationToken cancellationToken = default) =>
        SendCommandAsync("save_eeprom", new { }, cancellationToken);
