...
namespace MakerPrompt.Test.E2E.Maui.Fixtures;
...
public class AppiumSetup : IAsyncLifetime
{
    ...
    /// <summary>
    /// Kills any leftover MakerPrompt.UI.MAUI processes that could be holding
    ...
    private static void KillExistingAppInstances()
    {
        try
        {
            foreach (var proc in Process.GetProcessesByName("MakerPrompt.UI.MAUI"))
            {
